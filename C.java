...
j6 = new JLabel("Date of Admission.\n",JLabel.CENTER);
...
j10=new JLabel("ADD PATIENT HERE!!!", JLabel.CENTER);
Font f=new Font("Jokerman", Font.BOLD, 30);
j10.setFont(f);
j10.setBounds(50,50,370,30);
...
if(ae.getSource() == jb)
{
   ...
   statement.executeUpdate("insert into Add_Patient(Patient_id,Patient_name, Address,Phone_no,User_id,Date_of_Admission,Diseases,Room_no,Bed_no) values("+a+",'"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"')");
